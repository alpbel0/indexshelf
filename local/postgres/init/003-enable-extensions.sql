...
REVOKE CREATE ON SCHEMA identity, bookmarks, reminders, search, operations FROM PUBLIC;
GRANT USAGE ON SCHEMA public TO indexshelf_backend_runtime;
GRANT USAGE ON SCHEMA identity, bookmarks, reminders, search, operations TO indexshelf_backend_runtime;
GRANT USAGE, CREATE ON SCHEMA public TO indexshelf_product_migrator;
GRANT USAGE, CREATE ON SCHEMA identity, bookmarks, reminders, search, operations TO indexshelf_product_migrator;
...
ALTER DEFAULT PRIVILEGES FOR ROLE indexshelf_product_migrator IN SCHEMA identity, bookmarks, reminders, search, operations
  GRANT SELECT, INSERT, UPDATE, DELETE ON TABLES TO indexshelf_backend_runtime;
ALTER DEFAULT PRIVILEGES FOR ROLE indexshelf_product_migrator IN SCHEMA identity, bookmarks, reminders, search, operations
  GRANT USAGE, SELECT ON SEQUENCES TO indexshelf_backend_runtime;
